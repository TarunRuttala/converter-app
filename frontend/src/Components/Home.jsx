    ...
    <div className='max-w-screen-2xl max-auto container px-6 py-3 md:px-40 '>
        <div className='flex h-screen items-center justify-center'>
            ...
            <div className='flex flex-col items-center space-y-4'>
                ...
                <label htmlFor="FileInput" className='w-full flex items-center justify-center px-4 py-6 bg-gray-100 text-gray-700 rounded-lg shadow-lg cursor-pointer border-blue-300 hover:bg-blue-700 duration-300 hover:text-white'><FaRegFileWord className='text-2xl mr-3'/><span className='text-3xl mr-2'>{fileName?fileName.name:"Choose File"}</span></label>
                <button onClick={handleSubmit} disabled={!fileName} className='text-white bg-blue-500 hover:bg-blue-700 disabled:bg-gray-400 disabled:pointer-events-none duration-300 font-bold px-4 py-2 rounded-lg '>Convert File</button>
